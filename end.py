...
#
# class MControlAPI:
#     def __init__(self, symbol, resolution='D', data_from=None, data_to=None):
#         self.symbol = symbol
...
#             df['dt'] = pd.to_datetime(df['t'] + 55800, unit='s')
#
...
def main():
    ...
    if entered_password == "///":
        ...
        data_to_string = st.text_input("Enter data_to (2024-03-07 15:30:00.0):")
